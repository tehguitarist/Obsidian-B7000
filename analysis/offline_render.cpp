...
static const FitField kFitFields[] = {
    ...
    // OD-path makeup, the OD:CLEAN ratio (s172, item 10 / A3). 0 dB = pre-s172 behaviour.
    ...
    {"odMakeupLowS", &FitParams::odMakeupLowS},
    {"odMakeupHighS", &FitParams::odMakeupHighS},
    // The MIX-KEYED HF term (s173). All gains 0 = inert, bit-identical to pre-s173.
    ...
    {"odNotchDepthDb", &FitParams::odNotchDepthDb},
    {"c21R", &FitParams::c21R},
