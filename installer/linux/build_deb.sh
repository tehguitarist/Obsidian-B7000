#!/usr/bin/env bash
# Builds a .deb installer for Obsidian-B7000's VST3 from an already-built Release artefact.
...
#
# Requires the ObsidianB7000_VST3 target to already be built, and dpkg-deb installed.
...
mkdir -p "$OUTDIR"
OUT_DEB="$OUTDIR/Obsidian-B7000-Linux-v${VERSION}-Installer.deb"
